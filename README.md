...
- [main.py](/D:/projects/geo/bigmodel-excel-bot/main.py)：CLI 主程序，负责 Excel 读写、浏览器自动化、来源提取
- [api.py](/D:/projects/geo/bigmodel-excel-bot/api.py)：FastAPI 接口，封装同步接口和后台任务接口
- [requirements.txt](/D:/projects/geo/bigmodel-excel-bot/requirements.txt)：依赖列表
- [config.example.json](/D:/projects/geo/bigmodel-excel-bot/config.example.json)：通用配置模板
- [config.doubao.json](/D:/projects/geo/bigmodel-excel-bot/config.doubao.json)：豆包实跑配置
- [config.json](/D:/projects/geo/bigmodel-excel-bot/config.json)：本地或模拟配置
- [mock_chat.html](/D:/projects/geo/bigmodel-excel-bot/mock_chat.html)：本地模拟页面
- [data](/D:/projects/geo/bigmodel-excel-bot/data)：测试 Excel、输出结果目录
...
参考模板见 [config.example.json](/D:/projects/geo/bigmodel-excel-bot/config.example.json)。
...
GEO API 封装在 [api.py](/D:/projects/geo/bigmodel-excel-bot/api.py)。
...
- `config_path`：运行配置，默认 `config.doubao.json`
- `output_dir`：输出目录，Excel 和 JSON 都会落在这里，默认 `data/geo-runs`
...
```json
{
  ...
  "excel_path": "D:/projects/geo/bigmodel-excel-bot/data/geo-runs/20260418-233629-geo-run-geo.xlsx",
  "json_path": "D:/projects/geo/bigmodel-excel-bot/data/geo-runs/20260418-233629-geo-run-geo.json",
  "excel_rows": [
    {
...
- 对应落地文件见：
  - [20260418-233629-geo-run-geo.xlsx](/D:/projects/geo/bigmodel-excel-bot/data/geo-runs/20260418-233629-geo-run-geo.xlsx)
  - [20260418-233629-geo-run-geo.json](/D:/projects/geo/bigmodel-excel-bot/data/geo-runs/20260418-233629-geo-run-geo.json)
...
```bash
git clone https://github.com/dangwenxiang/bigmodel-excel-bot.git
cd bigmodel-excel-bot
```
...
```powershell
Set-Location D:\projects\geo\bigmodel-excel-bot
python -m uvicorn api:app --host 127.0.0.1 --port 8000
```
...
- `Application`：`D:\miniforge\python.exe`
- `Arguments`：`-m uvicorn api:app --host 127.0.0.1 --port 8000`
- `Startup directory`：`D:\projects\geo\bigmodel-excel-bot`
