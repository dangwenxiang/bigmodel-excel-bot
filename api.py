...
class GeoOptimizeRequest(BaseModel):
    ...
    config_path: str = Field(default="config.doubao.json", description="Runtime config path")
    output_dir: str = Field(default="data/geo-runs", description="Directory for generated xlsx")
